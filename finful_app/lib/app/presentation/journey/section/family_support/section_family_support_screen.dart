          ...
          sliver: SliverToBoxAdapter(
            child: Column(
              children: [
                ...
                Text(
                  L10n.of(context)
                      .translate('section_familySupport_title'),
                  style: Theme.of(context).textTheme.displayMedium!.copyWith(
                ...
                Padding(
                  ...
                  child: Text(
                    L10n.of(context)
                        .translate('section_familySupport_description'),
...
class SectionFamilySupportScreen extends StatefulWidget {
  const SectionFamilySupportScreen({
    super.key,
  });

  @override
  State<SectionFamilySupportScreen> createState() => _SectionFamilySupportScreenState();
}
